package coid.bcafinance.pcmtugasakhir.utils;

import coid.bcafinance.pcmtugasakhir.controller.AuthControllerTest;
...
public class TokenGenerator {
    ...
    public void doLoginManual(){
        ...
        req.put("username", AuthControllerTest.ADMIN_USER_NAME);
        req.put("password", AuthControllerTest.ADMIN_PASSWORD);
        Response response;
        ...
        try {
            ...
            response =  given().
                    ...
                    header("accept","*/*").body(req).request(Method.POST, "api/auth/v1/login");
